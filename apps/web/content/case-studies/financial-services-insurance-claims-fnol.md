...
title: "Regional P&C Insurer Cuts Claims Inquiry Call Volume 68% with 24/7 AI Status Updates"
industry: Financial Services
useCase: Insurance Claims & FNOL
companySize: 450 employees, 35,000 claims/year
location: 6-state footprint
metaTitle: "Insurance Claims FNOL Case Study | QuickVoice"
metaDescription: "A regional P&C insurer used QuickVoice AI for 24/7 claims status and FNOL intake, cutting claims inquiry volume 68% and saving $612K/year."
canonical: https://quickvoice.co/case-studies/financial-services-insurance-claims-fnol
ogImage: ""
heroStat: "-68%"
heroStatLabel: "Claims inquiry call reduction"
tags: [Financial Services, Insurance, Claims, FNOL, Guidewire]
---
...
> "The math was simple. We could spend $340,000 a year on an answering service that still could not tell a policyholder the status of their claim, or we could spend less than that on an AI that was connected directly to Guidewire and could answer the question in real time. It was not a close call."
> — Robert Ochoa, Vice President of Claims
