...
title: "Boutique Hotel Chain Generates $39,600/Year in Upsell Revenue from Pre-Arrival AI Calls"
industry: Travel & Hospitality
useCase: Hotel Reservations & Upsell
companySize: 85 employees, 200 rooms total
location: Southeast US
metaTitle: "Hotel Reservation Upsell Case Study | QuickVoice"
metaDescription: "A 3-property boutique hotel chain used QuickVoice AI pre-arrival calls to generate $39,600/year in upsell revenue and save $141,600 in labor costs."
canonical: https://quickvoice.co/case-studies/travel-hotel-reservations-upsell
ogImage: ""
heroStat: "$181K"
heroStatLabel: "Total annual benefit"
tags: [Travel, Hospitality, Hotels, Upsell, Reservations, Multilingual]
---
...
> "The other options could do one or two things well. QuickVoice was the only platform that could make the call, speak the language, close the sale, and update our PMS — all in a single interaction. That is what made the decision easy."
> — James Whitfield, Revenue Director
...
> "We used to think of the pre-arrival window as dead time. Now it is our highest-converting sales channel. The AI calls feel like a personal concierge reaching out, and our guests love it. The upsell revenue is great, but the real win is that guests arrive already excited about their stay."
> — James Whitfield, Revenue Director
...
> "Every hotel operator I talk to asks where they should invest next. My answer is always the same now: invest in the conversation between booking and arrival. That one phone call changed our entire revenue trajectory."
> — James Whitfield, Revenue Director
