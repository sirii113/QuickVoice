<<<<<<< HEAD
---
slug: logistics-freight-broker-carrier-capacity
title: "Digital Freight Brokerage Covers 3x More Loads with AI Carrier Outreach"
industry: Logistics & Supply Chain
useCase: Carrier Capacity
companySize: 85 employees, 35 carrier reps
location: National
metaTitle: "Freight Broker Carrier Capacity Case Study | QuickVoice"
metaDescription: "A digital freight brokerage used QuickVoice AI carrier outreach to cover 3x more loads per rep, generating $23M in annual revenue increase."
canonical: https://quickvoice.co/case-studies/logistics-freight-broker-carrier-capacity
ogImage: ""
heroStat: "3x"
heroStatLabel: "Loads covered per rep"
tags: [Logistics, Freight Brokerage, Carrier Capacity, TMS, Load Board]
---
...
1. **Introduction and load summary:** The agent identifies the brokerage, provides the origin/destination, pickup date, equipment type, and weight.
2. **Availability check:** The agent asks whether the carrier has a truck available in the pickup area on the specified date.
3. **Rate range qualification:** If the carrier is available, the agent provides a target rate range and asks whether the carrier can work within that range. The rate range is set by the brokerage's pricing team with minimum and maximum parameters.
4. **Interest confirmation:** If the carrier confirms availability and rate fit, the agent collects the carrier's preferred rate, truck number, driver name, and contact information.
5. **Warm transfer or callback scheduling:** Interested carriers are either transferred live to a carrier rep for final negotiation and booking, or scheduled for a callback within 15 minutes if all reps are engaged.
