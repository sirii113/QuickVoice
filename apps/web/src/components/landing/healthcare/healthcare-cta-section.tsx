    ...
    <div className="flex items-center w-full justify-center px-6 py-16">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          >
            Discover How QuickVoice Can Transform Your Healthcare Operations
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Join leading healthcare organizations using QuickVoice to improve patient experience,
            reduce no-shows, and streamline operations. Get started with a free demo today.
          </motion.p>
