...
export function AutomotiveCtaSection() {
  return (
    <div className="flex items-center w-full justify-center px-6 py-16">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          >
            Discover How QuickVoice Can Transform Your Automotive Business
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Gain insights on how we&apos;re helping automotive dealerships improve efficiency and productivity.
            Explore the benefits of conversational AI for your dealership and start
