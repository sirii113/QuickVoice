    ...
    <div className="flex items-center w-full justify-center px-6 py-16">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          >
            Discover How QuickVoice Can Elevate Your Ecommerce Business
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Gain insights on how we&apos;re helping brands improve efficiency and productivity.
            Explore the benefits of conversational AI for your ecommerce business and start
