...
export default function AboutUs1() {
  ...
  return (
    <section className="relative w-full overflow-hidden pt-20">
      <Spotlight
        gradientFirst="radial-gradient(68.54% 68.72% at 55.02% 31.46%, hsla(221, 83%, 56%, 0.08) 0, hsla(221, 83%, 56%, 0.04) 50%, hsla(221, 83%, 56%, 0) 80%)"
        gradientSecond="radial-gradient(50% 50% at 50% 50%, hsla(221, 83%, 85%, 0.08) 0, hsla(221, 83%, 65%, 0.04) 80%, transparent 100%)"
        gradientThird="radial-gradient(50% 50% at 50% 50%, hsla(221, 83%, 85%, 0.06) 0, hsla(221, 83%, 85%, 0.06) 80%, transparent 100%)"
      />
